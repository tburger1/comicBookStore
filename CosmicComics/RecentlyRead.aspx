<%@ Page Title="" Language="C#" MasterPageFile="~/MyComic.Master" AutoEventWireup="true" CodeBehind="RecentlyRead.aspx.cs" Inherits="CosmicComics.RecentlyRead" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    <h2>Recently Read Comics</h2>
    <h3>Display All:</h3>
    <asp:GridView ID="gridViewRecentlyRead" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="RecentlyReadSqlDataSource" ForeColor="#333333" GridLines="None" CssClass="GridPosition">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Expr1008" HeaderText="Count" SortExpression="Expr1008" Visible="False" />
        </Columns>
    ...
    <asp:SqlDataSource ID="RecentlyReadSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CosmicComicsConnectionString %>" ProviderName="<%$ ConnectionStrings:CosmicComicsConnectionString.ProviderName %>"
        SelectCommand="SELECT ComicTitle, ComicPublisher, ComicVolume, ComicIssue, ComicReleaseDate, ComicPrice, ComicRating, ComicCover, COUNT(*)
            ...
            AND tblCategoryType.RecentlyRead = -1
