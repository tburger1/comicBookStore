<%@ Page Title="" Language="C#" MasterPageFile="~/MyComic.Master" AutoEventWireup="true" CodeBehind="Recommended.aspx.cs" Inherits="CosmicComics.Recommended" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <h3>Display All:</h3>
    <asp:GridView ID="gridViewRecommended" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="RecommendedSqlDataSource" ForeColor="#333333" GridLines="None" CssClass="GridPosition">
    ...
    <asp:SqlDataSource ID="RecommendedSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CosmicComicsConnectionString %>" ProviderName="<%$ ConnectionStrings:CosmicComicsConnectionString.ProviderName %>"
        SelectCommand="SELECT ComicTitle, ComicPublisher, ComicVolume, ComicIssue, ComicReleaseDate, ComicPrice, ComicRating,  ComicCover, COUNT(*)
            ...
            AND tblCategoryType.Recommended = -1
